...
std::list<std::wstring> FindFilesRecursive(std::wstring path, const std::wstring name) {
	throw std::exception("FindFilesRecursive not implemented!");
...
std::list<std::wstring> FindFilesRecursive(std::wstring path, const std::wstring name) {
	...
	// TODO:
	// This is not working on Win10. I think, it wasn't a great idea to implement it myself. 
	// Consider to find cross-platform lib for file-searching purposes
